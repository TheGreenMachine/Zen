...
public class ThreeScoreFromDistanceMode extends AutoMode {
    ArrayList<DynamicAutoPath> paths;
    boolean scramAtEnd;
    TrajectoryAction scramAction;

    public ThreeScoreFromDistanceMode(List<DynamicAutoPath> paths, boolean scramAtEnd) {
    ...
    protected void routine() throws AutoModeEndedException {
        runAction(
                new SeriesAction(
                        ...
                        trajectoryActions.get(1),//Note 1 to note 2
